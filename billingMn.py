...
root=Tk()
root.title('Bill Optimization System By ATIF')
...
# ===========Function===============
def total():
    if Burger.get()==0 and Pizza.get()==0 and Wrap.get()==0 and Sandwich.get()==0:
...
def receipt():
    ...
    textarea.insert(END,f'\n\n Pizza     \t\t{Pizza.get()}\t  {cw.get()}')
    textarea.insert(END,f'\n\n Wrap      \t\t{Wrap.get()}\t  {cr.get()}')
    textarea.insert(END,f'\n\n Sandwich  \t\t{Sandwich.get()}\t  {cg.get()}')
    textarea.insert(END, f"\n\n================================")
...
title=Label(root,pady=5,text="Bill Optimization System By ATIF",bd=12,bg=bg_color,fg='white',font=('times new roman', 35 ,'bold'),relief=GROOVE,justify=CENTER)
title.pack(fill=X)

#===============Product Details=================
F1 = LabelFrame(root, text='Product Details', font=('times new romon', 18, 'bold'), fg='Yellow',bg=bg_color,bd=15,relief=RIDGE)
...
burger=Label(F1, text='Burger', font=('times new rommon',20, 'bold'), fg='Yellow',bg=bg_color)
burger.grid(row=1,column=0,padx=20,pady=15)
b_txt=Entry(F1,font='arial 15 bold',relief=SUNKEN,bd=7,textvariable=Burger,justify=CENTER)
...
pizza=Label(F1, text='Pizza', font=('times new rommon',20, 'bold'), fg='Yellow',bg=bg_color)
pizza.grid(row=2,column=0,padx=20,pady=15)
w_txt=Entry(F1,font='arial 15 bold',relief=SUNKEN,bd=7,textvariable=Pizza,justify=CENTER)
...
wrap=Label(F1, text='Wrap', font=('times new rommon',20, 'bold'), fg='Yellow',bg=bg_color)
wrap.grid(row=3,column=0,padx=20,pady=15)
r_txt=Entry(F1,font='arial 15 bold',relief=SUNKEN,bd=7,textvariable=Wrap,justify=CENTER)
...
sandwich=Label(F1, text='Sandwich', font=('times new rommon',20, 'bold'), fg='Yellow',bg=bg_color)
sandwich.grid(row=4,column=0,padx=20,pady=15)
g_txt=Entry(F1,font='arial 15 bold',relief=SUNKEN,bd=7,textvariable=Sandwich,justify=CENTER)
...
t=Label(F1, text='Total', font=('times new rommon',20, 'bold'), fg='Yellow',bg=bg_color)
